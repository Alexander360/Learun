...
{
    #region --ServiceStack.Redis因商业授权弃用--
    /// <summary>
    ...
    //    public static void List_Add<T>(string key, T t, int dbId=0)
    //    {
    ...
    //    /// <param name="dbId">库</param>
    //    /// <returns></returns>
    //    public static bool List_Remove<T>(string key, T t, int dbId=0)
    //    {
    //        using (IRedisClient redis = CreateManager(dbId).GetClient())
    //        {
    //            var redisTypedClient = redis.As<T>();
    ...
    //    /// <param name="key">键值</param>
    //    /// <param name="dbId">库Id</param>
    //    public static void List_RemoveAll<T>(string key, int dbId=0)
    //    {
    //        using (IRedisClient redis = CreateManager(dbId).GetClient())
    //        {
    //            var redisTypedClient = redis.As<T>();
    ...
    //    /// <returns></returns>
    //    public static long List_Count(string key, int dbId=0)
    //    {
    //        using (IRedisClient redis = CreateManager(dbId).GetClient())
    //        {
    ...
    //    /// <param name="dbId">库</param>
    //    /// <returns></returns>
    //    public static List<T> List_GetRange<T>(string key, int start, int count, int dbId=0)
    //    {
    //        using (IRedisClient redis = CreateManager(dbId).GetClient())
    //        {
    //            var c = redis.As<T>();
    ...
    //    /// <returns></returns>
    //    public static List<T> List_GetList<T>(string key, int dbId=0)
    //    {
    //        using (IRedisClient redis = CreateManager(dbId).GetClient())
    //        {
    //            var c = redis.As<T>();
    ...
    //    /// <param name="dbId">库</param>
    //    /// <returns></returns>
    //    public static List<T> List_GetList<T>(string key, int pageIndex, int pageSize, int dbId=0)
    //    {
    ...
    //    /// <param name="dbId">库</param>
    //    public static void Set_Add<T>(string key, T t, int dbId=0)
    //    {
    //        using (IRedisClient redis = CreateManager(dbId).GetClient())
    //        {
    //            var redisTypedClient = redis.As<T>();
    ...
    //    /// <param name="dbId">库</param>
    //    /// <returns></returns>
    //    public static bool Set_Contains<T>(string key, T t, int dbId=0)
    //    {
    //        using (IRedisClient redis = CreateManager(dbId).GetClient())
    //        {
    //            var redisTypedClient = redis.As<T>();
    ...
    //    /// <param name="dbId">库</param>
    //    /// <returns></returns>
    //    public static bool Set_Remove<T>(string key, T t, int dbId=0)
    //    {
    //        using (IRedisClient redis = CreateManager(dbId).GetClient())
    //        {
    //            var redisTypedClient = redis.As<T>();
    ...
    //    /// <param name="dbId">库</param>
    //    /// <returns></returns>
    //    public static bool Hash_Exist<T>(string key, string dataKey, int dbId=0)
    //    {
    //        using (IRedisClient redis = CreateManager(dbId).GetClient())
    //        {
    ...
    //    /// <param name="dbId">库</param>
    //    /// <returns></returns>
    //    public static bool Hash_Set<T>(string key, string dataKey, T t, int dbId=0)
    //    {
    //        using (IRedisClient redis = CreateManager(dbId).GetClient())
    //        {
    ...
    //    /// <param name="dbId">库</param>
    //    /// <returns></returns>
    //    public static bool Hash_Remove(string key, string dataKey, int dbId=0)
    //    {
    //        using (IRedisClient redis = CreateManager(dbId).GetClient())
    //        {
    ...
    //    /// <param name="dbId">库</param>
    //    /// <returns></returns>
    //    public static bool Hash_Remove(string key, int dbId=0)
    //    {
    //        using (IRedisClient redis = CreateManager(dbId).GetClient())
    //        {
    ...
    //    /// <param name="dbId">库</param>
    //    /// <returns></returns>
    //    public static T Hash_Get<T>(string key, string dataKey, int dbId=0)
    //    {
    //        using (IRedisClient redis = CreateManager(dbId).GetClient())
    //        {
    ...
    //    /// <param name="dbId">库</param>
    //    /// <returns></returns>
    //    public static List<T> Hash_GetAll<T>(string key, int dbId=0)
    //    {
    //        using (IRedisClient redis = CreateManager(dbId).GetClient())
    //        {
    ...
    //    /// <param name="dbId">库</param>
    //    public static bool SortedSet_Add<T>(string key, T t, double score, int dbId=0)
    //    {
    //        using (IRedisClient redis = CreateManager(dbId).GetClient())
    //        {
    //            string value = ServiceStack.Text.JsonSerializer.SerializeToString<T>(t);
    ...
    //    /// <param name="dbId">库</param>
    //    /// <returns></returns>
    //    public static bool SortedSet_Remove<T>(string key, T t, int dbId=0)
    //    {
    //        using (IRedisClient redis = CreateManager(dbId).GetClient())
    //        {
    //            string value = ServiceStack.Text.JsonSerializer.SerializeToString<T>(t);
    ...
    //    /// <param name="dbId">库</param>
    //    /// <returns></returns>
    //    public static long SortedSet_Trim(string key, int size, int dbId=0)
    //    {
    //        using (IRedisClient redis = CreateManager(dbId).GetClient())
    //        {
    ...
    //    /// <param name="dbId">库</param>
    //    /// <returns></returns>
    //    public static long SortedSet_Count(string key, int dbId=0)
    //    {
    //        using (IRedisClient redis = CreateManager(dbId).GetClient())
    //        {
    ...
    //    /// <param name="dbId">库</param>
    //    /// <returns></returns>
    //    public static List<T> SortedSet_GetList<T>(string key, int pageIndex, int pageSize, int dbId=0)
    //    {
    //        using (IRedisClient redis = CreateManager(dbId).GetClient())
    //        {
    ...
    //    /// <param name="dbId">库</param>
    //    /// <returns></returns>
    //    public static List<T> SortedSet_GetListALL<T>(string key, int dbId=0)
    //    {
    //        using (IRedisClient redis = CreateManager(dbId).GetClient())
    //        {
    ...
    //    /// <param name="datetime">过期时间</param>
    //    /// <param name="dbId">库</param>
    //    public static void SetExpire(string key, DateTime datetime, int dbId=0)
    //    {
    //        using (IRedisClient redis = CreateManager(dbId).GetClient())
    //        {
    ...
    public class RedisCache
    {
        ...
        /// </summary>
        private static RedisConfigInfo redisConfigInfo = RedisConfigInfo.GetConfig();
        private static string Constring = redisConfigInfo.WriteServerList;
        ...
        public static T Get<T>(string key, int dbId = 0) where T : class
        {
            ...
            return db.StringGet(key).IsNullOrEmpty ? default(T) : value.ToString().ToObject<T>();
        }
        /// <summary>
        /// 移除单体
        /// </summary>
